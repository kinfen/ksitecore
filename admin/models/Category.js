...
Category.add({
	...
	parent: {label:"父级", type: Types.Relationship, ref: 'Category', treeMode:true, initial:true },
	navs:{label:"所属模块", type: Types.Relationship, ref: 'Navs', treeMode:true ,initial:true},
